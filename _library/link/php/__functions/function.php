			...
			$output = $output . '<div class="title_secondary" style="display:inline-block;">';
				...
				$output = $output . '<div class="content_group">';
					...
					$output = $output . '<div class="content_rightside">';
						...
						$output = $output . "<p style='margin:37px 0 0 0;'>In the fall of 2006, Christopher, his brother, Jonathan, and father, De, conceived a unique motorcycle lifestyle company that would be based on respecting the past and building on the rich history of the ride. They set out on an adventure to create an enduring company by carefully and painstakingly building trusting relationships with those who love to ride.</p>
							<p style='margin:28px 0 0 0;'>In the third year of the adventure, spring of 2009, Christopher suffered a brain aneurysm and passed away. His loss left an immeasurable chasm in the hearts of so many family and friends which is why his love of life, undying passion, creativity, laughter, and deep joy live on in our memories and influence Rottweiler to this day. His pictures adorn our walls and his intensity is woven into the fabric of the company. Each member of the RMC team is specially chosen to continue the adventure and build on Christopher’s vision. Christopher would love what Rottweiler has become.
							<p style='margin:28px 0 0 0;'>Rottweiler Motorcycle Company is the fulfillment of a promise to Christopher, our friends, family, and our customers to choose adventure over comfort.</p>
							<p style='margin:28px 0 0 0;'>What a ride.</p>";
					$output = $output . '</div>';
				$output = $output . '</div>';
			$output = $output . '</div>';
		$output = $output . '</div>';
